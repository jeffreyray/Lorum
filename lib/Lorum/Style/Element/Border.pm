package Lorum::Style::Element::Border;
...
use Lorum::Constants qw( %GiDocStyleBorderWidth );
use Lorum::Types qw( GiDocStyleBorderWidth GiDocStyleBorderStyle GiDocStyleColor );
